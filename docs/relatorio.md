...
Outro aprendizado importante foi a necessidade de autocontrole da equipe diante dos débitos identificados. Mesmo quando algumas correções parecem simples, a ansiedade para iniciar refatorações deve ser equilibrada com a análise de sua complexidade e de seus possíveis efeitos sobre o restante do sistema. Dar andamento a mudanças sem discussão prévia ou planejamento pode criar novos débitos de forma indesejada ou até agravar o problema com débitos mais complexos. Por isso, reconhecer uma oportunidade de melhoria não significa que ela deva ser executada imediatamente, mas que precisa ser avaliada e tratada no momento adequado.
